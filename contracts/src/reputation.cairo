...
mod Reputation {
    ...
    use super::{
        ...
        REP_SUBSCRIBER_GAINED, REP_REPORT_VALID, REP_SPAM_PENALTY,
        BADGE_FIRST_POST, BADGE_PROLIFIC_WRITER, BADGE_CENTURY_CLUB,
        BADGE_FEATURED_AUTHOR, BADGE_CONVERSATIONALIST, BADGE_BELOVED,
        BADGE_EARLY_ADOPTER, BADGE_VERIFIED, BADGE_TOP_WRITER,
        BADGE_PREMIUM_AUTHOR, BADGE_TRUSTED, BADGE_GUARDIAN,
